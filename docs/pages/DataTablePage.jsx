...
class DataTablePage extends React.Component {
  constructor() {
    ...
    /*eslint-disable */
    this.data = [{"id":1,"work_no":"23-4608596","given_name":"哲恒","family_name":"鲁","name":"鲁哲恒","birthday":"1986-03-24","email":"landrews0@storify.com","gender":"Male","achievement":81.0,"remark":"bibendum imperdiet nullam orci pede"},
  ...
  render() {
    const columns = [{
      ...
      field: 'birthday',
      sorter: 'custom',
      style: (val) => {if (val.indexOf('1986') > -1) return { 'background': '#ccc' }},
    }, {
      label: 'Work No',
      field: 'work_no',
